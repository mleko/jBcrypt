 ...
 * call the hash method with a random salt, like this:
 * <p>
 * <code>
...
public class BCrypt {
    ...
    public static String hash(String password, String salt) {
        ...
        saltBytes = Base64.decode(real_salt, BCRYPT_SALT_LEN);

        B = new BCrypt();
        hashed = B.cryptRaw(passwordBytes, saltBytes, rounds, bf_crypt_ciphertext.clone());
        ...
        rs.append(Base64.encode(hashed, bf_crypt_ciphertext.length * 4 - 1));
        return rs.toString();
    }
    ...
    public static String generateSalt(int log_rounds, SecureRandom random) {
        ...
        rs.append("$");
        rs.append(Base64.encode(rnd, rnd.length));
        return rs.toString();
    }
    ...
    public static boolean verify(String password, String hashed) {
        ...
        byte try_bytes[];
        try {
            String try_pw = hash(password, hashed);
